...
public:
	...
	int getConfig(int item, unsigned long* value);
	int labelFilter(int channel, int label, int action);
	int getLatest(int channel, int label, void *data, char *seq_num);
	int numRChans();
	int numTChans();
...
private:
	...
	int getBaudRate(int channel, int trx, unsigned long* value);
	int getParity(int channel, int trx, unsigned long* value);
	int getDecoder(int channel, unsigned long* value);
	int getSDI(int channel, unsigned long* value);
	int getLookBack(int channel, unsigned long* value);
