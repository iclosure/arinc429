...
int __stdcall SetUserHandle(UserHandle pUser);
...
short __stdcall  ar_getnextt (unsigned short board, unsigned short channel,
                     void *destination, void *timetag);
